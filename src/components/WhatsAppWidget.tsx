...
export function WhatsAppWidget() {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50">
      {open && (
        <div className="mb-3 w-72 overflow-hidden rounded-2xl border border-white/10 bg-black shadow-2xl">
          ...
          <a
            ...
            className="block bg-[#25d366] py-3 text-center text-sm font-semibold text-white transition-all hover:shadow-[0_0_20px_rgba(37,211,102,0.5)]"
          >
            Start chat
          </a>
        </div>
      ...
      <button
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25d366] text-white shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-[0_0_24px_rgba(37,211,102,0.55)]"
      >
